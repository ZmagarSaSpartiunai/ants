...
const EN: Dict = {
  ...
  campaign: 'Campaign',
  level: 'Level',
  campaignDone: 'Every level beaten',
  nextLevel: 'Next level',
  retry: 'Try again',
  stats: 'Statistics',
  resetStats: 'Reset statistics',
  goalWipe: 'Be the last colony standing',
  goalHomes: 'Take every rival nest',
  goalHold: 'Hold %n nodes at once',
  minutes: 'min',
  statMatches: 'Matches',
  statWins: 'Won',
  statStreak: 'Best run of wins',
  statLevels: 'Levels beaten',
  statTaken: 'Nodes taken',
  statLostNodes: 'Nodes lost',
...
const UK: Dict = {
  ...
  goalWipe: 'Лишитись єдиною колонією',
  goalHomes: 'Захопити всі ворожі домівки',
  goalHold: 'Утримувати %n вузлів одночасно',
  minutes: 'хв',
  statMatches: 'Матчів',
  statWins: 'Перемог',
  statStreak: 'Найдовша серія',
  statLevels: 'Рівнів пройдено',
  statTaken: 'Захоплено вузлів',
  statLostNodes: 'Втрачено вузлів',
...
const PL: Dict = {
  ...
  hintSupply: 'Węzeł odcięty od domu przestaje rosnąć',
  offline: 'Serwer niedostępny — gra jednoosobowa działa', connecting: 'Łączenie',
  roomFull: 'Pokój pełny', noRoom: 'Nie ma takiego pokoju',
  ...
  campaign: 'Kampania',
  level: 'Poziom',
  campaignDone: 'Wszystkie poziomy ukończone',
  nextLevel: 'Następny poziom',
  retry: 'Jeszcze raz',
  stats: 'Statystyki',
  resetStats: 'Zresetuj statystyki',
  goalWipe: 'Zostań jedyną kolonią',
  goalHomes: 'Zdobądź wszystkie wrogie gniazda',
  goalHold: 'Utrzymaj %n węzłów naraz',
  minutes: 'min',
  statMatches: 'Mecze',
  statWins: 'Wygrane',
  statStreak: 'Najdłuższa seria',
  statLevels: 'Ukończone poziomy',
  statTaken: 'Zdobyte węzły',
  statLostNodes: 'Utracone węzły',
...
const DE: Dict = {
  ...
  hintSupply: 'Ein abgeschnittener Knoten wächst nicht mehr',
  offline: 'Server nicht erreichbar — Einzelspieler läuft', connecting: 'Verbinde',
  roomFull: 'Raum ist voll', noRoom: 'Raum nicht gefunden',
  ...
  goalWipe: 'Die letzte Kolonie sein',
  goalHomes: 'Alle gegnerischen Nester nehmen',
  goalHold: '%n Knoten gleichzeitig halten',
  minutes: 'Min',
  statMatches: 'Partien',
  statWins: 'Gewonnen',
  statStreak: 'Längste Serie',
  statLevels: 'Level geschafft',
  statTaken: 'Knoten erobert',
  statLostNodes: 'Knoten verloren',
...
const ES: Dict = {
  ...
  hintSupply: 'Un nodo aislado deja de crecer',
  offline: 'Servidor no disponible — un jugador funciona', connecting: 'Conectando',
  roomFull: 'Sala llena', noRoom: 'No existe esa sala',
  ...
  goalWipe: 'Ser la última colonia',
  goalHomes: 'Tomar todos los nidos rivales',
  goalHold: 'Mantener %n nodos a la vez',
  minutes: 'min',
  statMatches: 'Partidas',
  statWins: 'Ganadas',
  statStreak: 'Mejor racha',
  statLevels: 'Niveles superados',
  statTaken: 'Nodos tomados',
  statLostNodes: 'Nodos perdidos',
...
const PT: Dict = {
  ...
  hintSupply: 'Um nó isolado deixa de crescer',
  offline: 'Servidor indisponível — um jogador funciona', connecting: 'A ligar',
  roomFull: 'Sala cheia', noRoom: 'Sala não encontrada',
  ...
  goalWipe: 'Ser a última colónia',
  goalHomes: 'Tomar todos os ninhos rivais',
  goalHold: 'Manter %n nós ao mesmo tempo',
  minutes: 'min',
  statMatches: 'Partidas',
  statWins: 'Vitórias',
  statStreak: 'Melhor sequência',
  statLevels: 'Níveis concluídos',
  statTaken: 'Nós tomados',
  statLostNodes: 'Nós perdidos',
